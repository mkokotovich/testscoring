...
class ASRS_6_18(BaseAssessment):
    ...
    items = [
        ...
        ItemDescription('3', description='', group='SC|PS', reverse_scoring=True),
        ItemDescription('4', description='', group='SC|SER'),
        ItemDescription('5', description='', group='SR|AT', reverse_scoring=True),
        ItemDescription('6', description='', group='SR'),
        ItemDescription('7', description='', group='SR'),
        ItemDescription('8', description='', group='SC|DSM|SER', reverse_scoring=True),
        ItemDescription('9', description='', group='SC|DSM|SER', reverse_scoring=True),
        ItemDescription('10', description='', group='AT', reverse_scoring=True),
        ItemDescription('11', description='', group='DSM|SER'),
        ItemDescription('12', description='', group='SC', reverse_scoring=True),
        ItemDescription('13', description='', group='UB|DSM|BR'),
        ItemDescription('14', description='', group='PS'),
        ItemDescription('15', description='', group='DSM|SER', reverse_scoring=True),
        ...
        ItemDescription('23', description='', group='SC|DSM', reverse_scoring=True),
        ...
        ItemDescription('28', description='', group='SC|DSM|SER', reverse_scoring=True),
        ItemDescription('29', description='', group='UB|DSM|SS'),
        ItemDescription('30', description='', group='SR|AT'),
        ItemDescription('31', description='', group='SC|DSM|PS', reverse_scoring=True),
        ItemDescription('32', description='', group='SC|DSM|SER', reverse_scoring=True),
        ItemDescription('33', description='', group='SC|DSM|AS', reverse_scoring=True),
        ...
        ItemDescription('39', description='', group='SC|DSM|SER', reverse_scoring=True),
        ItemDescription('40', description='', group='UB|BR'),
        ItemDescription('41', description='', group='SER'),
        ItemDescription('42', description='', group='SC|DSM|SER', reverse_scoring=True),
        ItemDescription('43', description='', group='SC|DSM|SER', reverse_scoring=True),
        ItemDescription('44', description='', group='SR|AT'),
        ItemDescription('45', description='', group='SC|PS', reverse_scoring=True),
        ItemDescription('46', description='', group='UB|DSM|ST'),
        ItemDescription('47', description='', group='AT', reverse_scoring=True),
        ...
        ItemDescription('55', description='', group='SC|DSM|SER', reverse_scoring=True),
        ItemDescription('56', description='', group='SC|DSM', reverse_scoring=True),
        ...
        ItemDescription('61', description='', group='SC|DSM|SER', reverse_scoring=True),
        ...
        ItemDescription('69', description='', group='SC|DSM|PS', reverse_scoring=True),
        ItemDescription('70', description='', group='SC|DSM|PS', reverse_scoring=True),
