...
class CBCL_6_18(BaseAssessment):
    test_type = Test.CBCL_6_18
    ...
    def score_test(self, test):
        ...
        return self._convert_to_return_value(raw_scores, self.results_order, test)


class CBCL_1_5(BaseAssessment):
    test_type = Test.CBCL_1_5
